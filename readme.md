...
```
    ...
    AGENTSKILL1 VARCHAR(20) NOT NULL,
    AGENTSKILL2 VARCHAR(20) NOT NULL,
    AGENTSKILL3 VARCHAR(20) NOT NULL,
    AGENTSKILLDESCRIPTION1 VARCHAR(200) NOT NULL,
    AGENTSKILLDESCRIPTION2 VARCHAR(200) NOT NULL,
    AGENTSKILLDESCRIPTION3 VARCHAR(200)  NOT NULL,
    AGENTULTIMATE VARCHAR(20) NOT NULL,
    AGENTULTIMATEDESCRIPTION VARCHAR(200) NOT NULL,
    AGENTULTIMATEPOINTS INT NOT NULL;
    );
 ```
